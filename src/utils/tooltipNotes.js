...
const FIRE_APPARATUS_YEARS = new Set([2011, 2012, 2016, 2018, 2019]);
...
export function getTooltipNote(name, year) {
  ...
  if (name === 'Fire' && FIRE_APPARATUS_YEARS.has(year)) {
    ...
    if (year === 2011) return 'Includes ~$166K fire apparatus capital expenditure; recurring fire costs are closer to $64K.';
  }
